package com.yyy.demo.es;

import com.alibaba.fastjson.JSONObject;
import com.yyy.demo.es.dto.MyEsDTO;
...
public class EsIndexRequestTest {
    ...
    private void setEsDTO(MyEsDTO esDTO){
    ...
    private String esDTO2Json(MyEsDTO esDTO){
        String jsonSource = "{\n" +
                "    \"id\":\"" +
                esDTO.getId() +
                "\",\n" +
